...
docker-compose up -d
```
Within the output of the terminal will be QR codes you can (if you choose) to setup it WireGuard on your phone, or you can found the configs file in : `wirepius-radarr-sonarr/WireHole/wireguard`
```bash
